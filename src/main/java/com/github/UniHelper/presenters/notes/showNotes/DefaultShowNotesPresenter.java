...
public class DefaultShowNotesPresenter implements ShowNotesPresenter {

    private final ShowNotesView view;
    private final NotesModel model;

    public DefaultShowNotesPresenter(ShowNotesView notesView) {
        view = notesView;
